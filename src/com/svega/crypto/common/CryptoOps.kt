...
object CryptoOps {
    ...
    fun sc_reduce32(s: ByteArray): ByteArray{
        val ret = Arrays.copyOf(s, 32)
        var s0 = 2097151L and load_3(ret, 0)
        var s1 = 2097151L and (load_4(ret, 2) shr 5)
        var s2 = 2097151L and (load_3(ret, 5) shr 2)
        ...
        ret[0] = (s0 shr 0).toByte()
        ret[1] = (s0 shr 8).toByte()
        ret[2] = ((s0 shr 16) or (s1  shl  5)).toByte()
        ret[3] = (s1 shr 3).toByte()
        ret[4] = (s1 shr 11).toByte()
        ret[5] = ((s1 shr 19) or (s2  shl  2)).toByte()
        ret[6] = (s2 shr 6).toByte()
        ret[7] = ((s2 shr 14) or (s3  shl  7)).toByte()
        ret[8] = (s3 shr 1).toByte()
        ret[9] = (s3 shr 9).toByte()
        ret[10] = ((s3 shr 17) or (s4  shl  4)).toByte()
        ret[11] = (s4 shr 4).toByte()
        ret[12] = (s4 shr 12).toByte()
        ret[13] = ((s4 shr 20) or (s5  shl  1)).toByte()
        ret[14] = (s5 shr 7).toByte()
        ret[15] = ((s5 shr 15) or (s6  shl  6)).toByte()
        ret[16] = (s6 shr 2).toByte()
        ret[17] = (s6 shr 10).toByte()
        ret[18] = ((s6 shr 18) or (s7  shl  3)).toByte()
        ret[19] = (s7 shr 5).toByte()
        ret[20] = (s7 shr 13).toByte()
        ret[21] = (s8 shr 0).toByte()
        ret[22] = (s8 shr 8).toByte()
        ret[23] = ((s8 shr 16) or (s9  shl  5)).toByte()
        ret[24] = (s9 shr 3).toByte()
        ret[25] = (s9 shr 11).toByte()
        ret[26] = ((s9 shr 19) or (s10  shl  2)).toByte()
        ret[27] = (s10 shr 6).toByte()
        ret[28] = ((s10 shr 14) or (s11  shl  7)).toByte()
        ret[29] = (s11 shr 1).toByte()
        ret[30] = (s11 shr 9).toByte()
        ret[31] = (s11 shr 17).toByte()
